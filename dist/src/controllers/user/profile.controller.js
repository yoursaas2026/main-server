...
function pickClientProfile(client) {
    return {
        ...
        primaryGoals: JSON.parse(client.primaryGoals || '[]'),
...
export class UserProfileController {
    ...
    async updateProfile(c) {
        ...
        if (data.buyerRole !== undefined)
            update.buyerRole = data.buyerRole;
