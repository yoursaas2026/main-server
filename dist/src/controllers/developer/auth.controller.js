...
function pickDeveloperPublicProfile(dev) {
    return {
        id: dev.id,
        name: dev.name,
        email: dev.email,
        ...
        servicesOffered: dev.servicesOffered,
        pastExperiences: dev.pastExperiences,
        portfolioProjects: dev.portfolioProjects,
...
export class DeveloperAuthController {
    ...
    async handleOAuthCallback(_c, userData) {
