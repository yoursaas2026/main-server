...
const marketingAuthRoutes = new Hono();
...
const marketingListsRoutes = new Hono();
...
const marketingTemplatesRoutes = new Hono();
...
export { marketingAuthRoutes, marketingListsRoutes, marketingTemplatesRoutes, marketingCampaignsRoutes, };
